...
from Dist_Probability import Gaussian
from Dist_Probability import Binomial

class TestGaussianClass(unittest.TestCase):
    def setUp(self):
        self.gaussian = Gaussian(25, 2)
        self.gaussian.read_data_file('txt/numbers.txt')
...
class TestBinomialClass(unittest.TestCase):
    def setUp(self):
        ...
        self.binomial.read_data_file('txt/numbers_binomial.txt')
